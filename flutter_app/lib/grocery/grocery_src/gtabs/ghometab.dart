...
// my import
import 'package:flutter_app/grocery/grocery_src/gtabs/gdetails.dart';
import 'package:flutter_app/grocery/grocery_src/gwidgets/gcategory.dart';
import 'package:flutter_app/grocery/grocery_src/gwidgets/glistitem1.dart';
import 'package:flutter_app/grocery/grocery_src/gwidgets/glistitem2.dart';
      ...
      children: <Widget>[
        ...
        InkWell(
            ...
            child: GroceryListItemTwo(
                ...
                image: "assets/grocery_assets/grocery_images/capsicum.png",
                subtitle: "1 kg")),
        InkWell(
            onTap: () => _openDetailPage(context),
            child: GroceryListItemTwo(
        ...
        children: <Widget>[
          Expanded(
            child: InkWell(
              ...
              child: GroceryListItemOne(
                image: "assets/grocery_assets/grocery_images/mango.png",
                subtitle: "1 kg",
                title: "Local Mango",
              ),
            ),
          ...
          Expanded(
            child: InkWell(
              onTap: () => _openDetailPage(context),
              child: GroceryListItemOne(
                image: "assets/grocery_assets/grocery_images/brocoli.png",
      ...
      child: Row(
        children: <Widget>[
          ...
          GroceryCategory(
            ...
            image: 'assets/grocery_assets/grocery_images/vegetables.png',
            title: "Vegetables",
          ),
          SizedBox(
            width: 10.0,
          ...
          GroceryCategory(
            ...
            title: "Fruite",
            image: "assets/grocery_assets/grocery_images/fruit.png",
          ),
          SizedBox(
            width: 10.0,
          ),
          GroceryCategory(
            image: "assets/grocery_assets/grocery_images/mortar.png",
