...
import 'package:flutter_app/bmi_calculator/input_page/height/height_slider.dart';
import 'package:flutter_app/bmi_calculator/input_page/height/height_styles.dart';
...
class _HeightPickerState extends State<HeightPicker> {
  ...
  Widget _drawSlider() {
    return Positioned(
      child: BmiHeightSlider(height: widget.height),
      left: 0.0,
      right: 0.0,
  ...
  Widget _drawPersonImage() {
    ...
    return Align(
      ...
      child: SvgPicture.asset(
        "assets/bmi_assets/bmi_images/person.svg",
